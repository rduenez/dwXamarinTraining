...
namespace xBountyHunter.Views
{
    public class AcercaDePage : ContentPage
    {
        ...
        public AcercaDePage()
        {
            ...
            if (xBountyHunterApp.Current.Properties.ContainsKey("Rating"))
                srating.Value = (double)xBountyHunterApp.Current.Properties["Rating"];
            ...
            srating.ValueChanged += (sender, args) =>
                {
                    ...
                    xBountyHunterApp.Current.Properties["Rating"] = value;
                };
